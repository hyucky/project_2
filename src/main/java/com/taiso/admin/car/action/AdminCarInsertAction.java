...
//		request.getRealPath("");
	...
	//  2) 업로드 크기제어 ( 10 MB )
			...
			dto.setCar_category(multi.getParameter("car_category"));
			dto.setCar_location(0); // 0 제주 , 1 내륙
			dto.setCar_name(multi.getParameter("car_name"));
			dto.setCar_op(multi.getParameter("car_op"));
			dto.setCar_price(Integer.parseInt(multi.getParameter("car_price")));
			dto.setCar_year(Integer.parseInt(multi.getParameter("car_year")));
			dto.setcar_brand(multi.getParameter("car_brand"));
			dto.setCar_fuel(multi.getParameter("car_fuel"));
