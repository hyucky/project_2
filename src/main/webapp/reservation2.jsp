		...
		<!-- <h1>예약하기</h1> 여기쓰면 화면 어그러짐-->
          <div class="col-md-8 block-9 mb-md-5">
           ...
           <div class="form-group">
           	 <h3>회원정보</h3>	 
                이름 : <input type="text" name="name" class="form-control" value="${dto.name }"><br>
                           
                전화번호 : <input type="text" name="phone" class="form-control" value="${dto.tel }"><br>
                        
                생년월일 : <input type="text" name="birth" class="form-control" value="${dto.birth }"><br>

                이메일 : <input type="email" name="email" class="form-control" value="${dto.email }"><br>
              </div>
